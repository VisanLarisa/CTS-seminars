...
public class EmployeeStudent {
	int salaryPerHour;
	//int salary;	//nu are sens, pentru ca se calculeaza in functie de celelalte doua
	int hours;

	public void reportHours(int hours) {	//parametru sugestiv
		hours+=hours;	
...
//		}
	...
	public String getExam(int numberExam) throws Exception {
		String exams[]= {"OOP Exam", "Java Exam", "Data structure Exam", "C# Exam", "Statistics Exam"};	//mai rapid decat cu switchuri
